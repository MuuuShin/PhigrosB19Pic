...
def main(userName):
    ...
    draw.text(xy=(200, 15), text="rks:" + str(rks), fill=(0, 0, 0), font=fontExo)
    draw.text(xy=(460, 13), text="全曲共计φ: " + str(data['apNum']) + " 个,其中IN: " + str(data['apNumIN']) + " 个",
              fill=(255, 0, 0),
              font=fontYahei)
    c = 50
    for i in range(5):
